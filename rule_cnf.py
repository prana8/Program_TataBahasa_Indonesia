...
def get_set_of_production():
    global RESULT
    RESULT.clear()
    f = open("C:\\Users\\ryanp\\Documents\\Kampus\Matakuliah\\SEMESTER 3\\TBO (teori bahasa dan otomata)\\FinalProjrct\\Final-Project-TBO-bakcup\\rule_list.txt", "r", encoding="utf-8")
    for lines in f:
